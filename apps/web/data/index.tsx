...
export const heroSlides: HeroSlide[] = [
  {
    ...
    title: '업무를 더 스마트하게, %c',
    description:
      'ASM과 PIMS로 자산 관리부터 프로젝트 운영까지 — 하나의 플랫폼으로 모든 업무 흐름을 연결하세요.',
  },
  {
    id: 2,
    order: 1,
...
export const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    year: 2023,
    month: 10,
    description: 'ISO 27001 정보보안 인증 취득',
  },
  {
    id: 5,
    order: 5,
    ...
    year: 2023,
    month: 6,
    description: 'ASM 모바일 앱 출시 (iOS·Android)',
  },
  { id: 6, order: 6, isShow: true, year: 2023, month: 2, description: '시리즈 A 투자 유치' },
  {
    ...
    year: 2022,
    month: 9,
    description: 'PIMS(프로젝트 관리 시스템) 론칭',
  },
  { id: 8, order: 8, isShow: true, year: 2022, month: 4, description: '벤처기업 인증' },
  {
    ...
    year: 2021,
    month: 7,
    description: 'ASM(자산 관리 시스템) 베타 서비스 개시',
  },
...
export const testimonialItems: TestimonialItem[] = [
  ...
  {
    lines: ['프로젝트 납기 준수율이 눈에 띄게 올랐습니다.', '리소스 배분 뷰가 특히 유용합니다.'],
    name: '박성호',
    role: 'PMO 실장',
    company: '미래건설 주식회사',
    rating: 4,
...
export const clientItems: ClientItem[] = [
  ...
  {
    name: '우정정보관리원(우체국금융)',
    url: 'https://kpds.koreapost.go.kr/',
    logo: '/clients/koreapost.png',
  },
  ...
  addresses: [
    {
      ...
      order: 1,
      embbedUrl:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3162.919945!2d126.977929!3d37.566576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca2012d5c39cf%3A0x7e11eca1405bf29b!2z7ISc7Jq47IucIOyEseyLnCDshqHsmIHroZw!5e0!3m2!1sko!2skr!4v1700000000000!5m2!1sko!2skr',
    },
    {
      label: '지사',
      ...
      order: 2,
      embbedUrl:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3171.836!2d127.028873!3d37.263504!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357b5f9c56e7cd67%3A0x84e78ef4e31b7bab!2z7IiY7JWE7IucIOyEseyLnCDsiJjslYTrjIDsnYQ!5e0!3m2!1sko!2skr!4v1700000000000!5m2!1sko!2skr',
    },
  ],
  tel: '000-000-0000',
  fax: '000-000-0000',
