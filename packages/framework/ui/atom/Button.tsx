...
export const SdButton = {
  ...
  Cancel: createButton(
    { variant: 'outline', color: 'slate', leftSection: <IconX size={16} /> },
    '취소',
  ),
  /** 엑셀 — outline green + 스프레드시트 아이콘, 기본 라벨 "엑셀" */
  Excel: createButton(
    { variant: 'outline', color: 'green', leftSection: <IconFileSpreadsheet size={16} /> },
    '엑셀',
  ),
  /** 다운로드 — light primary + 다운로드 아이콘, 기본 라벨 "다운로드" */
  Download: createButton(
    { variant: 'light', color: 'primary', leftSection: <IconDownload size={16} /> },
    '다운로드',
  ),
}
