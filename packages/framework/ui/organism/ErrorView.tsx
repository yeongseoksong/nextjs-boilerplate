      ...
      <SdContainer>
        <Stack align="center" gap="lg" ta="center">
          ...
          <Group gap="sm" justify="center">
            ...
            {onHome && <SdButton.Ghost onClick={onHome}>홈으로</SdButton.Ghost>}
          </Group>
        </Stack>
      </SdContainer>
    </Center>
    ...
    <Center mih="60vh">
      <SdContainer>
        <Stack align="center" gap="lg" ta="center">
          ...
          <Group gap="sm" justify="center">
            {onHome && <SdButton.Primary onClick={onHome}>홈으로</SdButton.Primary>}
            {onBack && <SdButton.Ghost onClick={onBack}>뒤로 가기</SdButton.Ghost>}
          </Group>
        </Stack>
      </SdContainer>
    </Center>
